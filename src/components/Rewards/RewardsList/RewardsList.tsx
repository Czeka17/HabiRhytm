...
const DUMMY_REWARDS = [
    ...
    { name: 'Dont let your addiction win for 6 hours', condition: 'addiction-6-hours' },
    { name: 'Dont let your addiction win for a day', condition: 'addiction-day' },
    { name: 'Dont let your addiction win for a week', condition: 'addiction-week' },
    { name: 'Dont let your addiction win for a month', condition: 'addiction-month' },
    { name: 'Dont let your addiction win for a year', condition: 'addiction-year' },
